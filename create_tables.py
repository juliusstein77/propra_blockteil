...
if mode == "CREATE":
  ...
  cursor.execute("CREATE TABLE IF NOT EXISTS Proteins (id INT AUTO_INCREMENT PRIMARY KEY, head VARCHAR(250) NOT NULL, CONSTRAINT Proteins_Seq_fk_1 FOREIGN KEY (head) REFERENCES Sequences (source_id) ON DELETE CASCADE)")
